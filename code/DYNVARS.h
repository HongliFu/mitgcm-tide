...
C           implicDiv2DFlow=0 => etaH=etaN ; =1 => etaH=etaNm1 ;
     ...
     &                   guNm1,gvNm1,gtNm1,gsNm1
      ...
      _RL  gsNm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
        ...
        common /tgp_xfz/
     &                   elm1,elm2,elbar,elm0
      _RL  elm1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  elm2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  elbar(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  elm0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
     
        common /tgp_forecast_fhl/
     &           H1,H2,elt,H0,G1,G2,G0,elday,elmeanfhl
      _RL  H1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  H2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  elt(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  H0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  G1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  G2(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  G0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
C      _RL  elday(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  elday(1-OLx:sNx+OLx,1-OLy:sNy+OLy,52,nSx,nSy)
      _RL  elmeanfhl(1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)

        common /climate_fhl/
     &      tclimate_fhl,sclimate_fhl,sclimate0,sclimate1,
     &      tclimate0,tclimate1
      _RL  tclimate_fhl(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  sclimate_fhl(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  tclimate0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  tclimate1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  sclimate0(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  sclimate1(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
